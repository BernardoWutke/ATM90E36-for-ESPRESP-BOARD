...
/*================================ FEITO POR ESPRESP=================================*/
// kWH ENERGY
double ATM90E36::GetEnergyA()
{
  unsigned short energy = CommEnergyIC(READ, APenergyA, 0xFFFF);
  // printa dado bruto
  Serial.print("Energy A Raw: ");
  Serial.println(energy);
  return (double)energy;
}
double ATM90E36::GetEnergyB()
{
  unsigned short energy = CommEnergyIC(READ, APenergyB, 0xFFFF);
  return (double)energy;
}
double ATM90E36::GetEnergyC()
{
  unsigned short energy = CommEnergyIC(READ, APenergyC, 0xFFFF);
  return (double)energy;
}
/*==================================================================================*/
